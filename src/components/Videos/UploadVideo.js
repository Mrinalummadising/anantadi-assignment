      ...
      <div className="text-center text-white p-2">
        <header className="flex justify-between items-center mb-5">
          <div className="flex items-center ">
            <img
              src="https://i.ibb.co/FxRbyJM/vms-logo.pngg"
              alt="Sierra logo"
              className="mr-3 h-8 w-8 rounded-full"
            />
            <span className="text-xl text-white font-bold">Sierra</span>
          </div>
          <Navbar />
        </header>
        <main>
          <p className="text-yellow-300 mb-1">#Repurpose video with AI</p>
          <h3 className="text-4xl text-yellow-500 md:text-5xl font-bold mb-2">
            Now Repurpose long video, 10x faster.
          </h3>
          <span className="text-lg">
            Sierra allows you to create new video content in just a few clicks,
            saving you time and effort.
          </span>
          <div className="max-w-lg mx-auto">
            <form
              onSubmit={handleSubmit}
              className="container mt-3 border-spacing-1 text-white"
            >
              <div className="mb-2">
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setimageurl(
                      e.target.value ||
                        "https://i.ibb.co/89wH9BH/videothumb.png"
                    )
                  }
              ...
              <button
                type="submit"
                className="bg-purple-900 text-white py-3 px-6 rounded-md"
              >
