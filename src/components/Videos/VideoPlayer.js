    ...
    <div className="p-4 bg-purple-700 min-h-screen text-gray-100 flex flex-col">
      <header className="text-white shadow-sm flex items-center justify-between px-6">
        <div className="flex items-center">
          <img
            src="https://i.ibb.co/FxRbyJM/vms-logo.png"
            alt="Sierra logo"
            className="h-8 w-8 rounded-full"
          />
          <h1 className="text-xl text-white font-bold ml-2">Sierra</h1>
        </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {video.hashtags ||
                  "#ViralScore #BuzzMeter #ContentImpact #ViralScore #BuzzMeter"}
              </p>
            </div>
            <div>
